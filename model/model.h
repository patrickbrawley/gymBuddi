...
// Input 0 ('Input3') size: 12288
// Output 0 ('Block224947') size: 1000
void model_Predict(void* context, float* Input3, float* Block224947);
...
public:
    ModelWrapper()
    {
        _model_Predict_Block224947.resize(GetOutputSize(0));
    ...
    std::vector<float>& Predict(std::vector<float>& Input3)
    {
        model_Predict(this, Input3.data(), _model_Predict_Block224947.data());
        return _model_Predict_Block224947;
    }


private:
    std::vector<float> _model_Predict_Block224947;
